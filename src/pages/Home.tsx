      ...
      <main className="flex-1">
        ...
        <section className="bg-primary text-white py-24 px-4">
          <div className="container mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">AYITILOAN</h1>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Des solutions de prêt flexibles jusqu'à 500 000 HTG pour répondre à tous vos besoins financiers.
            </p>
            <Link to="/demande">
              <Button className="bg-secondary text-primary hover:bg-secondary/90 font-bold px-8 py-6 text-lg">
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Pourquoi Choisir AYITILOAN?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="text-primary text-4xl mb-4">💰</div>
                <h3 className="text-xl font-bold mb-3">Taux Compétitifs</h3>
        ...
        <section className="py-16 px-4 bg-primary text-white">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">Prêt à Demander un Prêt?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
